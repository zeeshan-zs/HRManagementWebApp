...
{
    [CustomErrorHandling]
    public class POEmployeesController : Controller
    {
        ...
        {            
            ...
            POEmployee poEmployee = db.POEmployees.Find(idd);
            if (poEmployee != null)
            {
                db.POEmployees.Remove(poEmployee);
                db.SaveChanges();
                return Json(poEmployee);
            }
            //return RedirectToAction("Index");
        ...
        [HttpPost]
        public JsonResult testajax(string id)
        {
            string yyo = id;
            string message = "SUCCESS" + yyo;
            return Json(message);
        }
